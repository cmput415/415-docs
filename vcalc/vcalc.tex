...
\assertion{All vectors will have length $l$ such that $0 \leq 0 \leq 2^{32}$.}{vector-length}
...
\begin{enumerate}
  \item
    ...
    All vectors will have length $l$ such that $0 \leq 0 \leq 2^{32}$. Trying to create an index
