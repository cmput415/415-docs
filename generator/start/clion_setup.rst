...
#. Make sure you’re building the ``all`` target, not just the
   ``generator`` target. From the drop down menu in the top right of the
   IDE you can choose your build target. Change this to ``Build All``.
