...
\begin{enumerate}
  ...
  \item
    There is no specified syntax guide for use with \textit{inja} thus you \textbf{could} write
    your strings in any style that you choose. However, \textbf{software design practices, which
    include code legibility, form part of your grade}. Therefore, I suggest you use
    \href{https://softwareengineering.stackexchange.com/q/254984}{implicit string concatenation} to
    delineate your strings. For example, this may be a format string for literal division:
    \begin{lstlisting}
