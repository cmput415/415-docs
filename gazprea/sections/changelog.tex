...
\begin{itemize}
  \item
    ...
    \begin{itemize}
      \item Fixed \code{and} precedence in \nameref{ssec:boolean} \nameref{sssec:boolean_ops}.
    \end{itemize}
  \item
    \textbf{2018/11/08 3:15PM}
    \begin{itemize}
      \item Fixed \code{by} precedence in \nameref{ssec:interval} \nameref{sssec:interval_ops}.
    \end{itemize}
  \item
    \textbf{2018/11/07 1:15PM}
    \begin{itemize}
      \item Added access (dot) operator to \nameref{ssec:tuple} \nameref{sssec:tuple_ops}.
      \item Defined \code{tuple-expr} in \nameref{ssec:tuple} \nameref{sssec:tuple_ops}.
    \end{itemize}
  \item
